...
oil =[
    ...
    52.63, 52.75, 53.9, 53.55, 53.81, np.nan, 52.19, 52.37, 52.99, 53.84,
...
def buy(price, limit):
    if price < limit:
        return "Buy"
    return "wait"
print(oil_series.apply(buy, args=(oil_series.quantile(.9),)))

print(np.where(oil_series.index.isin(['2016-12-23', '2017-05-10']),
               oil_series * 0.9,
               oil_series * 1.1))
