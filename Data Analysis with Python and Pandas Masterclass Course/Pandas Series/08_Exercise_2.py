...
oil_series = pd.Series(oil, index=dates, name="oil prices")
print(oil_series)

mean_first_10 = oil_series.iloc[:11].mean()
mean_last_10 = oil_series.iloc[-11:].mean()
print(mean_first_10)
print(mean_last_10)

january_oil = oil_series.loc["2017-01-01" : "2017-01-07"].astype(int).reset_index(drop=True)
print(january_oil)
