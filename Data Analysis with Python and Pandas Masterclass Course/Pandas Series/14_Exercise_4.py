...
increased_price = oil_series * 1.1 + 2
highest = increased_price.max()
price_difference = (increased_price - highest) / highest
print(price_difference)

extracting_month = oil_series.index.astype(str).str.slice(5, 7).astype(int)
month_series = pd.Series(extracting_month)
print(month_series)